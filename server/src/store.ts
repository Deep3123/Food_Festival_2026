...
function seedFoodItems(): FoodItem[] {
  return [
    // --- Tandoori Tech (North Indian) ---
    {
      id: "item-paneer-tikka",
      name: "Paneer Tikka",
      imageUrl: "https://cdn.bytebites.demo/paneer-tikka.jpg",
      description: "Char-grilled cottage cheese cubes in smoky tandoori masala.",
      rating: 4.6,
    ...
    },
    {
      id: "item-butter-naan",
      name: "Butter Naan",
      imageUrl: "https://cdn.bytebites.demo/butter-naan.jpg",
    ...
    },
    {
      ...
      imageUrl: "https://cdn.bytebites.demo/chicken-biryani.jpg",
    ...
    // --- Wok & Roll (Pan-Asian) ---
    {
      ...
      imageUrl: "https://cdn.bytebites.demo/hakka-noodles.jpg",
      description: "Stir-fried noodles tossed with crunchy garden vegetables.",
      rating: 4.1,
    ...
    },
    {
      ...
      imageUrl: "https://cdn.bytebites.demo/schezwan-rice.jpg",
      description: "Wok-tossed rice with fiery Schezwan sauce and spring onion.",
      rating: 4.4,
    ...
    },
    {
      ...
      imageUrl: "https://cdn.bytebites.demo/veg-momos.jpg",
      description: "Delicate steamed dumplings served with spicy red chutney.",
      rating: 4.2,
      availableQuantity: 0, // sold out — exercises the unavailable path
      price: 90,
      stallId: "stall-wok",
      spice: "mild",
      flavor: "savory",
    ...
    // --- Sweet Bytes (Desserts & drinks) ---
    {
      id: "item-gulab-jamun",
      name: "Gulab Jamun",
      imageUrl: "https://cdn.bytebites.demo/gulab-jamun.jpg",
    ...
    {
      id: "item-choco-brownie",
      name: "Choco Lava Brownie",
      imageUrl: "https://cdn.bytebites.demo/choco-brownie.jpg",
      description: "Molten dark chocolate brownie with a gooey fudge centre.",
      rating: 4.5,
    ...
    },
    {
      id: "item-mango-lassi",
      name: "Mango Lassi",
      imageUrl: "https://cdn.bytebites.demo/mango-lassi.jpg",
      description: "Thick chilled yogurt smoothie blended with alphonso mango.",
      rating: 4.0,
